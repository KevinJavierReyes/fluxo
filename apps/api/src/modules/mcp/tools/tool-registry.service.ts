...
import { fluxoDescribeTool } from './generic/fluxo-describe.tool';
import { fluxoGetTool } from './generic/fluxo-get.tool';
...
export class ToolRegistryService {
  ...
  constructor(
    ...
    this.tools = [
      ...
      fluxoGetTool(registry),
      fluxoDescribeTool(registry),
