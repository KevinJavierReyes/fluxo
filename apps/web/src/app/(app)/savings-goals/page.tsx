...
import { useContributeSavingsGoal, useDeleteSavingsGoal, useSavingsGoals } from '@/hooks/use-savings-goals';
  ...
  return (
    <div className="flex flex-col gap-8">
      <PageHeader
        ...
        description="Define un objetivo y ve tu avance en tiempo real."
        action={<SavingsGoalFormDialog />}
      />
      ...
      {goals && goals.length === 0 && (
        <EmptyState
          message="Aún no tienes metas de ahorro."
          action={
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-1">
                    <SavingsGoalFormDialog
                      goal={goal}
                      trigger={
                        <Button type="button" variant="ghost" size="icon-sm" aria-label="Editar meta">
                          <PencilIcon />
                        </Button>
                      }
                    />
